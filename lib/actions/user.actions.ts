...
export const signUp = async ({ password, ...userData}: SignUpParams) => {
    ...
    try{
        ...
        if (!newUserAccount) throw Error("An error occurred while creating a new user account");
        ...
        if (!dwollaCustomerUrl) throw Error("An error occurred while creating a Dwolla customer");
...
export const exchangePublicToken = async ({
    ...
    try{
        ...
        // If the fundingsource URL is not creayted, throw an error
